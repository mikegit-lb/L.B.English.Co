...
export const schedules = {
  ...
  TOEFL: ['Read a campus notice and identify purpose plus relevant detail', 'Build a clear response to an academic email prompt', 'Listen for the speaker’s main point and supporting reason', 'Practise an interview answer with one specific example', 'Complete a current-format TOEFL starter set', 'Review one response decision and repeat it with a clearer structure'],
  YOKDIL: ['Bağlaçları alan metinlerinde anlam ilişkisine göre ayır', 'Fen, sağlık ve sosyal bilimlerden bir paragraf seçip ana fikri bul', 'Çeviride kapsam ve kiplik işaretlerini kontrol et', 'Kanıt ile metin dışı bilgiyi birbirinden ayır', 'Süreli bir akademik okuma seti çöz', 'Haftanın alan ve kelime hatalarını yeniden çöz'],
