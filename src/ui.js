...
export const header = (page) => {
  ...
  <div class="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 bg-ink px-4 py-2.5 text-center text-xs font-medium tracking-wide text-white print:hidden"><div>BUILD YOUR ENGLISH <span class="mx-2 text-lime">/</span> Everyday, professional and Exams+ support. <a href="index.html#english-offers" class="ml-3 underline underline-offset-4">Explore your options ↗</a></div><nav aria-label="Site language" class="flex items-center gap-1"><a data-locale="en" href="${page}.html" lang="en" hreflang="en" aria-current="true" class="grid min-h-9 min-w-11 place-items-center rounded-full border border-white/30 px-3 font-bold aria-[current=true]:bg-lime aria-[current=true]:text-ink" aria-label="Switch to English">EN</a><a data-locale="tr" href="${page}-tr.html" lang="tr" hreflang="tr" aria-current="false" class="grid min-h-9 min-w-11 place-items-center rounded-full border border-white/30 px-3 font-bold aria-[current=true]:bg-lime aria-[current=true]:text-ink" aria-label="Türkçeye geç">TR</a></nav></div>
